...
nom_equipe_nationale VARCHAR(50) NOT NULL, 
nom_championnat VARCHAR(50) NOT NULL, 
poste VARCHAR(50) NOT NULL);

CREATE TABLE questions (q_id SERIAL PRIMARY KEY, question VARCHAR(150) NOT NULL);
INSERT INTO questions(question,liaison) VALUES ('le joueur est-il d''origine ','origine');
...
INSERT INTO questions(question,liaison) VALUES ('le joueur joue t''il dans un championnat ','championnat');
